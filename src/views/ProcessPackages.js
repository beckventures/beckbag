...
class ProcessPackages extends React.Component {
          ...
          <Row>
            <Col md="12">
              <Card className="customcard" style={{ backgroundColor: 'transparent' }}>
                <CardHeader>
                  <CardTitle tag="h4" style={{ fontSize: '1.5em', fontWeight: '800', marginBottom: '25px' }}>List Of Matched Packages</CardTitle>
                </CardHeader>
                <CardBody>
