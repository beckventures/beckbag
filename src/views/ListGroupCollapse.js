...
class ListGroupCollapse extends React.Component {
  constructor(props) {
    super(props);
    this.shiftCompletedFlight = this.shiftCompletedFlight.bind(this);
    this.checkifFilled = this.checkifFilled.bind(this);
    this.updateCompletedFlight = this.updateCompletedFlight.bind(this);  
  ...
  updateCompletedFlight(){
    var that = this;
    var packagedetails = this.state.data;
    var flightnumber = packagedetails.recommended;
     database.ref('beckbag').child('flights').child(flightnumber)
              .once('value')
              .then((snapshot) => {
                var shifted = snapshot.val();
                that.shiftCompletedFlight(shifted,flightnumber);
              });

  }

  shiftCompletedFlight(shifted,flightnumber){
    database.ref('beckbag').child('upcomingflights').child(flightnumber)
              .set({
                shifted
              });
