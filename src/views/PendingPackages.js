...
class PendingPackages extends React.Component {
  ...
  var countinside = 0;
    ...
    database.ref('beckbag').child('merchantorders').child('added')
          ...
          <Row>
            <Col md="12">
              <Card className="customcard" style={{ backgroundColor: 'transparent' }}>
                <CardHeader>
                  <CardTitle tag="h4" style={{ fontSize: '1.5em', fontWeight: '800', marginBottom: '25px' }}>List Of Pending Packages</CardTitle>
                </CardHeader>
                <CardBody>
