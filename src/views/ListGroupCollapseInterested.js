...
class ListGroupCollapseInterested extends React.Component {
  constructor(props) {
    super(props);
  ...
  },
  {
    ...
    key: 'bookingdate',
    ...this.getColumnSearchProps('bookingdate'),
  },
  {
    title: 'Sent',
    dataIndex: 'followups',
    key: 'followups',
    ...this.getColumnSearchProps('followups'),
    render: text => <Tag color="cyan" key={text}>
              {text}
            </Tag>,
  },
  {
    ...
    key: 'followupdate',
    ...this.getColumnSearchProps('followupdate'),
...
export default ListGroupCollapseInterested