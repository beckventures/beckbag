...
import { ListGroup, ListGroupItem, Collapse, Row,
...
class ListGroupCollapseCompleted extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {collapse: false, collapsetracking: false, modal: false, modalapprove: false, data: null, ball: ball, inputtext: '', hideTracking: false};
  }
...
export default ListGroupCollapseCompleted